                        ...
                        <el-row>
                            <el-col :xs="7" :sm="0" :md="0" :lg="0" :xl="0">
                                <el-dropdown trigger="click">
                                    <el-button class="toggle-menu" size="mini" plain><i class="fa fa-align-justify"></i>
                                    </el-button>
                                ...
                                <el-popover
                                    ...
                                    <div>
                                        <el-input size="small" placeholder="请输入关键字" v-model="searchkey"
                                                  suffix-icon="el-icon-search" @keyup.enter.native="searchResult">
                                        </el-input>
                                    </div>
                                </el-popover>
                                <el-button v-popover:popoverSearch class="toggle-search" size="mini" plain><i
                        ...
                        <nav class="header-nav">
                            <ul>
                                ...
                                <li v-for="(nav,index) in headerNav" :key="index" v-once
                                    :class="{active : $route.fullPath =='/'+nav.defaultUrl+ '___'+nav._id}">
                                    <router-link :to="{path: '/'+nav.defaultUrl+ '___'+nav._id}">{{nav.name}}
                                    </router-link>
                                </li>
                            </ul>
